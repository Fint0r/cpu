...
HD_PWD='D:/Projects/Xilinx/CPU/CPU.runs/reg_file_blk_mem_gen_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reg_file_blk_mem_gen_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reg_file_blk_mem_gen_0_0.tcl
